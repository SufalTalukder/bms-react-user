                ...
                <div className="container">
                    <div className="footer-top-wrap">
                        <div className="footer-logo">
                            <Link to="home-ergonic-chair.html">
                                <img src="/assets/images/logo/logo.svg" className="logo" alt="logo" />
                            </Link>
                        </div>
                        <ul className="tf-social-icon style-large">
                            <li>
                                <Link to="https://www.facebook.com/" className="social-item social-facebook">
                                    <i className="icon icon-fb"></i>
                                </Link>
                            </li>
                            <li>
                                <Link to="https://www.instagram.com/" className="social-item social-instagram">
                                    <i className="icon icon-instagram"></i>
                                </Link>
                            </li>
                            <li>
                                <Link to="https://www.snapchat.com/" className="social-item social-linkedin"><i
                                    className="icon icon-linkedin"></i></Link>
                            </li>
                            <li>
                                <Link to="https://x.com/" className="social-item social-x">
                                ...
                                <div className="footer-contact">
                                    <ul className="footer-info">
                                        <li className="item">
                                            ...
                                            <Link target="_blank" to="https://www.google.com/maps?q=123Yarranst,Punchbowl,NSW2196,Australia">
                                        ...
                                        <li className="item">
                                            ...
                                            <Link to="tel:18888383022">(64) 8342 1245</Link>
                                        </li>
                                        <li className="item">
                                            <span className="box-icon">
                                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <Link to="https://www.google.com/maps?q=15Yarranst,Punchbowl,NSW,Australia"
                        ...
                        <div className="footer-inner-wrap footer-col-block s2">
                            ...
                            <div className="tf-collapse-content">
                                <div className="footer-newsletter">
                                    ...
                                    <form className="form-newsletter subscribe-form" acceptCharset="utf-8" data-mailchimp="true">
                                        <div className="subscribe-content">
                                            <fieldset className="email">
                                                <input type="email" name="email-form" className="subscribe-email" placeholder="Email address"
                                                    tabIndex={-1} aria-required="true" required />
                                            </fieldset>
                                            <div className="button-submit">
                                                <button className="subscribe-button animate-btn">
                        ...
                        <div className="footer-inner-wrap s3">
                            <div className="footer-col-block inner-col">
                                ...
                                <div className="tf-collapse-content">
                                    <ul className="footer-menu-list">
                                        ...
                                        <li>
                                            <Link to="store-location.html">Our Store</Link>
                                        </li>
                                        <li>
                                            <Link to="about-us.html">Our Story</Link>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div className="footer-col-block inner-col">
                                ...
                                <div className="tf-collapse-content">
                                    <ul className="footer-menu-list">
                                        <li>
                                            <Link to="privacy-policy.html">Privacy Policies</Link>
                                        </li>
                                        <li>
                                            <Link to="term-and-condition.html">Terms & Conditions</Link>
                                        </li>
                                        <li>
                                            <Link to="return-and-refund.html">Returns & Refunds</Link>
                                        </li>
                                        <li>
                                            <Link to="faq.html">FAQ’s</Link>
                                        </li>
                                        <li>
                                            <Link to="shipping.html">Shipping</Link>
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div className="footer-bottom">
                <div className="container">
                    <div className="footer-bottom-wrap">
                        <p className="text-dark">Copyright © 2025 by <span className="fw-medium">Vineta.</span> All Rights
                            Reserved.</p>
                        <ul className="tf-payment">
                            <li className="item"><img src="/assets/images/payment/EximBank.png" alt="payment" /></li>
                            <li className="item"><img src="/assets/images/payment/ApplePay.png" alt="payment" /></li>
                            <li className="item"><img src="/assets/images/payment/DinersClub.png" alt="payment" /></li>
                            <li className="item"><img src="/assets/images/payment/Discover.png" alt="payment" /></li>
                            <li className="item"><img src="/assets/images/payment/GooglePay.png" alt="payment" /></li>
                            <li className="item"><img src="/assets/images/payment/Mastercard-2.png" alt="payment" /></li>
                            <li className="item"><img src="/assets/images/payment/Mastercard.png" alt="payment" /></li>
                            <li className="item"><img src="/assets/images/payment/Shop.png" alt="payment" /></li>
                            <li className="item"><img src="/assets/images/payment/UnionPay.png" alt="payment" /></li>
                            <li className="item"><img src="/assets/images/payment/Visa.png" alt="payment" /></li>
                        </ul>
                    </div>
                </div>
            </div>
