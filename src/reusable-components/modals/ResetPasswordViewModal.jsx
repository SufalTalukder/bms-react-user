export default function ResetPasswordViewModal() {
    return (
        <div className="offcanvas offcanvas-end popup-style-1 popup-reset-pass" id="resetPass">
            <div className="canvas-wrapper">
                ...
                <div className="canvas-body popup-inner">
                    <form action="#" className="form-login">
                        <div>
                            <p className="text text-sm text-main-2">Forgot your password? No worries! Enter your registered
                        ...
                        <div className="bot">
                            <div className="button-wrap">
                                <button className="subscribe-button tf-btn animate-btn bg-dark-2 w-100" type="submit">Reset
                                    Password</button>
                                <button type="button" data-bs-dismiss="offcanvas" className="tf-btn btn-out-line-dark2 w-100">Cancel</button>
                            </div>
                        </div>
                    </form>
                </div>
